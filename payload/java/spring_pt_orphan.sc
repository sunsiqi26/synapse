...
@main def main(): Unit = {
    ...
    println("[*] Starting Phase 1 BFS Orphan-Stitching Engine for PT...")
  ...
  val sinkRegex = ".*(?:(?:java\\.io\\.(?:FileInputStream|FileOutputStream|FileReader|FileWriter)\\.<init>)|(?:java\\.nio\\.file\\.Files\\.(?:write|readAllBytes|delete))|(?:java\\.io\\.File\\.delete:)|(?:FileUtils\\.(?:delete|deleteDirectory|deleteDirectoryRecursively|read|write|readFileToString))).*"

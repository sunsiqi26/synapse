...
@main def main(): Unit = {
    ...
    println("[*] Starting Phase 0 Direct Dataflow Engine for RCE...")
  ...
  val sinkRegex = ".*(?:(?:java\\.lang\\.Runtime\\.exec)|(?:java\\.lang\\.ProcessBuilder\\.(?:start|command))|(?:org\\.springframework\\.expression\\.ExpressionParser\\.parseExpression)|(?:org\\.springframework\\.expression\\.Expression\\.getValue)|(?:javax\\.script\\.ScriptEngine\\.eval)|(?:groovy\\.lang\\.GroovyShell\\.evaluate)|(?:groovy\\.lang\\.GroovyClassLoader\\.parseClass)|(?:javax\\.naming\\.InitialContext\\.lookup)).*"
